...
connection.connect();
var getCharactersPageNames = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                image = $('.thumb.tright > a > img').attr('src');
                if (!name) {
...
var loadCharacters = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getCharactersPageNames()];
            case 1:
